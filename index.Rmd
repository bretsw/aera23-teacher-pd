...
# `r fa("far fa-compass", fill = "#fff")` <br><br> Recommendations
...
"Many participants appeared to use TikTok with limited awareness of how the platform works and related issues that could impact educators" [3]
...
**Socio-Ecological Model:** Individual + Interpersonal + Organizational + Community + Public policy [1]
